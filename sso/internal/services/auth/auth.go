...
import (
	...
	"fmt"
	"log/slog"
	"protos/sso/internal/domain/models"
	"protos/sso/internal/storage"
	"time"

	"golang.org/x/crypto/bcrypt"

	"protos/sso/internal/lib/jwt"
	"protos/sso/internal/lib/logger/sl"
)
...
func New(
	...
	return &Auth{
		...
		log:         log,
		appProvider: appProvider,
		tokenTTL:    tokenTTL, // Время жизни возвращаемых токенов (Time to live)
	}
}
